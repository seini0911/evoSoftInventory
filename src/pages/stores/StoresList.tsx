...
const StoresList = () => {
  ...
  const tableName= t('stores_list');
  const tableHeadings = [t('code'), t('name'), t('address'), t('actions')];
    return (
    <div className='container px-4'>
        ...
        <div className="container items-end justify-end mb-2 text-end justify-items-end">
          <CustomButtonExportCSV fileName={tableName} headersArray={tableHeadings.filter((heading) => heading !== t('actions'))} dataContent={stores}/>
        </div>
